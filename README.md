# Salt Extension for HashiCorp Consul
...
The saltext-consul project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-consul.git
...
* Writing blog posts
* Sharing your experiences using Salt + HashiCorp Consul
  on social media
...
[docs]: https://salt-extensions.github.io/saltext-consul/
